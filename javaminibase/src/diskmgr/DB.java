...
public class DB implements GlobalConst {
  ...
  public PCounter rwCounter = new PCounter();
  //rwCounter.initialize();
  ...
  public  void read_page(PageId pageno, Page apage)
    ...
    try{
      fp.read(buffer);
      rwCounter.readIncrement();
      //System.out.println("READ disk count is " + rwCounter.rcounter);
    }
    catch (IOException e) {
  ...
  public void write_page(PageId pageno, Page apage)
    ...
    try{
      ...
      rwCounter.writeIncrement();
      //System.out.println("WRITE disk count is " + rwCounter.wcounter);
    }
    catch (IOException e) {
      throw new FileIOException(e, "DB file I/O error");
    }
