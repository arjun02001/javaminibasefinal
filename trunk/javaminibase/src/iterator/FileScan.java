...
public class FileScan extends  Iterator
{
  ...
  public PositionData get_next_PositionData()
  throws JoinsException,
	   IOException,
	   InvalidTupleSizeException,
	   InvalidTypeException,
  ...
  {     
    ...
    while(true) {
	if((returnPD =  scan.getNextPositionData(rid)) == null) {//Anwasha doubts - does the rid get set here? then in scan i dont need the extra method  
	  return null;
	}
	tuple1 = returnPD.tuple;
	tuple1.setHdr(in1_len, _in1, s_sizes);
	if (PredEval.Eval(OutputFilter, tuple1, null, _in1, null) == true){
	  Projection.Project(tuple1, _in1,  Jtuple, perm_mat, nOutFlds); 
	  //return  Jtuple;
	  returnPD.tuple = Jtuple;
	  return returnPD;
	}        
    }
  }
